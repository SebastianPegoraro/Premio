...
class Usuario extends \AppBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'evaluador', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function setEvaluador(\AppBundle\Entity\Evaluador $evaluador = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEvaluador', [$evaluador]);

        return parent::setEvaluador($evaluador);
    }
    ...
    public function getEvaluador()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEvaluador', []);

        return parent::getEvaluador();
    }
