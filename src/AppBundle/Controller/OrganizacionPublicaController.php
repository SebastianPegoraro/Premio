 ...
 *
 * @Route("/organizacionpublica")
 */
class OrganizacionPublicaController extends Controller
{
    /**
     ...
     *
     * @Route("/", name="organizacionpublica_index")
     * @Method({"GET", "POST"})
     *
    ...
    public function indexAction(Request $request)
    {
        ...
        $organizacionPublicas = $this->paginate($queryBuilder, $request);

        return $this->render('organizacionpublica/index.html.twig', array(
    ...
    protected function filter(Request $request, Premio $premio)
    {
        ...
        $queryBuilder = $em->getRepository('AppBundle:OrganizacionPublica')
            ->createQueryBuilder('opu')
            ->andWhere('opu.premio = :premio')
            ->orderBy('opu.nombre')
     ...
     *
     * @Route("/new", name="organizacionpublica_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        return $this->render('organizacionpublica/new.html.twig', array(
     ...
     *
     * @Route("/{id}/enrolled", name="organizacionpublica_enrolled")
     */
     ...
     *
     * @Route("/{id}/show", name="organizacionpublica_show")
     * @Method("GET")
     */
    public function showAction(OrganizacionPublica $organizacionPublica)
    {
        ...
        return $this->render('organizacionpublica/show.html.twig', array(
            'organizacionPublica' => $organizacionPublica,
     ...
     *
     * @Route("/{id}/pdf", name="organizacionpublica_pdf")
     * @Method("GET")
     */
    public function pdfAction(OrganizacionPublica $organizacionPublica)
    {
        $html = $this->renderView('organizacionpublica/pdf.html.twig', array(
            'organizacionPublica' => $organizacionPublica,
        ));
     ...
     *
     * @Route("/pdf", name="organizacionpublica_list_pdf")
     * @Method("GET")
     */
    public function listPdfAction(Request $request)
    {
        ...
        $html = $this->renderView('organizacionpublica/pdf-list.html.twig', array(
            'organizacionPublicas' => $organizacionPublicas,
            'premioActual'         => $premioActual,
            'filterForm'           => $filterForm->createView(),
        ));
     ...
     *
     * @Route("/{id}/edit", name="organizacionpublica_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, OrganizacionPublica $organizacionPublica)
    {
        ...
        return $this->render('organizacionpublica/edit.html.twig', array(
            'organizacionPublica' => $organizacionPublica,
     ...
     *
     * @Route("/{id}", name="organizacionpublica_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, OrganizacionPublica $organizacionPublica)
    {
        ...
        return $this->redirectToRoute('organizacionpublica_index');
    }
    ...
    private function createDeleteForm(OrganizacionPublica $organizacionPublica)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('organizacionpublica_delete', array('id' => $organizacionPublica->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
    ...
    /**
     * @Route("/organizaciones-publicas.{_format}", defaults={"_format"="xlsx"}, requirements={"_format"="csv|xls|xlsx"}, name="organizacionpublica_list_excel")
     * @Template(":organizacionpublica:list-excel.xls.twig")
     */
